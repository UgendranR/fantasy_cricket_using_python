...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet("background-color:rgb( 255, 153, 51);")
        ...
        self.team_name.setStyleSheet("background-color:rgb(255, 153, 51);")
        ...
        self.points_available.setStyleSheet("color:rgb(51, 153, 51)")
        ...
        self.points_used.setStyleSheet("color:rgb(51, 153, 51)")
        ...
        #self.menuManage_Teams.setStyleSheet("background-color:rgb( 255, 153, 51);")
